...
import com.sinooceangroup.badgerNumber.impl.AdwHomeBadger;
import com.sinooceangroup.badgerNumber.impl.ApexHomeBadger;
import com.sinooceangroup.badgerNumber.impl.AsusHomeBadger;
import com.sinooceangroup.badgerNumber.impl.DefaultBadger;
import com.sinooceangroup.badgerNumber.impl.EverythingMeHomeBadger;
import com.sinooceangroup.badgerNumber.impl.HuaweiHomeBadger;
import com.sinooceangroup.badgerNumber.impl.NewHtcHomeBadger;
import com.sinooceangroup.badgerNumber.impl.NovaHomeBadger;
import com.sinooceangroup.badgerNumber.impl.OPPOHomeBader;
import com.sinooceangroup.badgerNumber.impl.SamsungHomeBadger;
import com.sinooceangroup.badgerNumber.impl.SonyHomeBadger;
import com.sinooceangroup.badgerNumber.impl.VivoHomeBadger;
import com.sinooceangroup.badgerNumber.impl.ZTEHomeBadger;
import com.sinooceangroup.badgerNumber.impl.ZukHomeBadger;
            ...
            synchronized (sCounterSupportedLock) {
                ...
                if (sIsBadgeCounterSupported == null) {
                    ...
                    for (int i = 0; i < SUPPORTED_CHECK_ATTEMPTS; i++) {
                        try {
                            Log.d(LOG_TAG, "Checking if platform supports badge counters, attempt "
                            ...
                            if (initBadger(context)) {
                                ...
                                Log.d(LOG_TAG, "Badge counter is supported in this platform.");
                                break;
                            } else {
...
//                                + lastErrorMessage);
    ...
    private static boolean initBadger(Context context) {
        ...
        if (launchIntent == null) {
            Log.d(LOG_TAG, "Unable to find launch intent for package " + context.getPackageName());
            return false;
        }
